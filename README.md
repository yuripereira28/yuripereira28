...
<p align="left">- Estudante da Formação Oracle One (Alura + Oracle)<br>- Estudando para realizar minha transição de carreira (RH para Desenvolvimento)<br>- Conhecimento em Git, Github, HTML, CSS, JavaScript e MySQL<br>- Básico em analise de dados: Power BI e Excel <br>- Estudando sobre IA no contexto da programação e aprendendo sobre Engenharia de Prompts <br>- Conhecimento em Gestão de Projetos e metodologias: Scrum e Kanban<br>- Experiência de UI/UX em um projeto - Criação da página de carreiras, usando Figma<br>- Soft skills: Proativo, flexível, autodidata, gosto de aprender sobre TI/IA e todo o contexto que envolve Programação.</p>
...
<img src="https://raw.githubusercontent.com/yuripereira28/yuripereira28/output/snake.svg" alt="Snake animation" />
